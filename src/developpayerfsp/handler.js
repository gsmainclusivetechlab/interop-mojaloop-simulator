...
exports.putParticipantsByTypeId = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/participants/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.postPartiesByTypeAndId = function (request, h) {
  ...
  Logger.info('IN DEVELOPPAYERFSP:: POST /developpayerfsp/parties/' + request.params.id, request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.getPartiesByTypeAndId = function (req, h) {
  (async function () {
    ...
    console.log((new Date().toISOString()), ['IN DEVELOPPAYERFSP::'], `received: ${metadata}. `)
...
exports.putPartiesByTypeId = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/parties/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putPartiesByTypeIdAndError = function (request, h) {
  console.log((new Date().toISOString()), 'IN DEVELOPPAYERFSP:: PUT /developpayerfsp/parties/' + request.params.id + '/error', request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.postQuotes = function (req, h) {
  (async function () {
    ...
    Logger.info((new Date().toISOString()), ['IN DEVELOPPAYERFSP::'], `received: ${metadata}. `)
...
exports.putQuotesById = function (request, h) {
  (async () => {
    ...
    Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/quotes/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putQuotesByIdAndError = function (request, h) {
  console.log((new Date().toISOString()), 'IN DEVELOPPAYERFSP:: PUT /developpayerfsp/quotes/' + request.params.id + '/error', request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.postTransfers = async function (req, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: received: ${metadata}.`)
...
exports.putTransfersById = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/transfers/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putTransfersByIdError = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/transfers/${request.params.id}/error, PAYLOAD: [${JSON.stringify(request.payload)}]`)
  correlationCache.set(request.params.id, request.payload)
...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/correlationid/${request.params.id}, CACHE: [${JSON.stringify(correlationCache.get(request.params.id))}]`)
...
exports.getRequestById = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/requests/${request.params.id}, CACHE: [${JSON.stringify(requestCache.get(request.params.id))}]`)
...
exports.getCallbackById = function (request, h) {
  ...
  Logger.info(`IN DEVELOPPAYERFSP:: PUT /developpayerfsp/callbacks/${request.params.id}, CACHE: [${JSON.stringify(callbackCache.get(request.params.id))}]`)
