...
exports.putParticipantsByTypeId = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/participants/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.postPartiesByTypeAndId = function (request, h) {
  ...
  Logger.info('IN LOCALPAYERFSP:: POST /localpayerfsp/parties/' + request.params.id, request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.getPartiesByTypeAndId = function (req, h) {
  (async function () {
    ...
    console.log((new Date().toISOString()), ['IN LOCALPAYERFSP::'], `received: ${metadata}. `)
...
exports.putPartiesByTypeId = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/parties/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putPartiesByTypeIdAndError = function (request, h) {
  console.log((new Date().toISOString()), 'IN LOCALPAYERFSP:: PUT /localpayerfsp/parties/' + request.params.id + '/error', request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.postQuotes = function (req, h) {
  (async function () {
    ...
    Logger.info((new Date().toISOString()), ['IN LOCALPAYERFSP::'], `received: ${metadata}. `)
...
exports.putQuotesById = function (request, h) {
  (async () => {
    ...
    Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/quotes/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putQuotesByIdAndError = function (request, h) {
  console.log((new Date().toISOString()), 'IN LOCALPAYERFSP:: PUT /localpayerfsp/quotes/' + request.params.id + '/error', request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.postTransfers = async function (req, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: received: ${metadata}.`)
...
exports.putTransfersById = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/transfers/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putTransfersByIdError = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/transfers/${request.params.id}/error, PAYLOAD: [${JSON.stringify(request.payload)}]`)
  correlationCache.set(request.params.id, request.payload)
...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/correlationid/${request.params.id}, CACHE: [${JSON.stringify(correlationCache.get(request.params.id))}]`)
...
exports.getRequestById = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/requests/${request.params.id}, CACHE: [${JSON.stringify(requestCache.get(request.params.id))}]`)
...
exports.getCallbackById = function (request, h) {
  ...
  Logger.info(`IN LOCALPAYERFSP:: PUT /localpayerfsp/callbacks/${request.params.id}, CACHE: [${JSON.stringify(callbackCache.get(request.params.id))}]`)
