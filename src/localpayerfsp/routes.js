...
module.exports = [
  ...
  {
    method: 'POST',
    path: '/localpayerfsp/parties/{type}/{id}',
  ...
  {
    method: 'PUT',
    path: '/localpayerfsp/quotes/{id}/error',
  ...
  {
    method: 'PUT',
    path: '/localpayerfsp/transfers/{id}',
  ...
  {
    method: 'PUT',
    path: '/localpayerfsp/transfers/{id}/error',
  ...
  {
    method: 'GET',
    path: '/localpayerfsp/correlationid/{id}',
