...
exports.putParticipantsByTypeId = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/participants/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.postPartiesByTypeAndId = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info('IN testfsp3:: POST /testfsp3/parties/' + request.params.id, request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.getPartiesByTypeAndId = function (req, h) {
  (async function () {
    ...
    console.log((new Date().toISOString()), ['IN testfsp3::'], `received: ${metadata}. `)
...
exports.putPartiesByTypeId = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/parties/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putPartiesByTypeIdAndError = function (request, h) {
  console.log((new Date().toISOString()), 'IN testfsp3:: PUT /testfsp3/parties/' + request.params.id + '/error', request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.postQuotes = function (req, h) {
  (async function () {
    ...
    Logger.isInfoEnabled && Logger.info((new Date().toISOString()), ['IN testfsp3::'], `received: ${metadata}. `)
...
exports.putQuotesByIdAndError = function (request, h) {
  console.log((new Date().toISOString()), 'IN testfsp3:: PUT /testfsp3/quotes/' + request.params.id + '/error', request.payload)
  correlationCache.set(request.params.id, request.payload)
...
exports.postTransfers = async function (req, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: received: ${metadata}.`)
...
exports.putTransfersById = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/transfers/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putTransfersByIdError = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/transfers/${request.params.id}/error, PAYLOAD: [${JSON.stringify(request.payload)}]`)
  correlationCache.set(request.params.id, request.payload)
...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/correlationid/${request.params.id}, CACHE: [${JSON.stringify(correlationCache.get(request.params.id))}]`)
...
exports.getRequestById = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/requests/${request.params.id}, CACHE: [${JSON.stringify(requestCache.get(request.params.id))}]`)
...
exports.getCallbackById = function (request, h) {
  ...
  Logger.isInfoEnabled && Logger.info(`IN testfsp3:: PUT /testfsp3/callbacks/${request.params.id}, CACHE: [${JSON.stringify(callbackCache.get(request.params.id))}]`)
