...
module.exports = [
  ...
  {
    method: 'PUT',
    path: '/testfsp1/transfers/{id}/error',
  ...
  {
    method: 'GET',
    path: '/testfsp1/correlationid/{id}',
