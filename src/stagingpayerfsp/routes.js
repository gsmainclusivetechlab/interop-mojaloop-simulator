...
module.exports = [
  ...
  {
    method: 'POST',
    path: '/stagingpayerfsp/parties/{type}/{id}',
  ...
  {
    method: 'PUT',
    path: '/stagingpayerfsp/quotes/{id}',
  ...
  {
    method: 'PUT',
    path: '/stagingpayerfsp/transfers/{id}',
  ...
  {
    method: 'PUT',
    path: '/stagingpayerfsp/transfers/{id}/error',
  ...
  {
    method: 'GET',
    path: '/stagingpayerfsp/correlationid/{id}',
